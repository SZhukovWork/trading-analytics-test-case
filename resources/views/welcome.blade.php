...
>
    <div style="display: flex;gap: 15px;align-items: center">
        <button id="loadUsers" style="background: #c68d28;border-radius: 10px;padding: 10px 12px">Импортировать
            пользователей
        </button>
        <div id="count">
            Всего:
    ...
    <script>
        document.getElementById("loadUsers").addEventListener("click", async e => {
            ...
            if (response.ok){
                ...
                if(body.success){
                    for(const key in body.data){
                        ...
                        elem.querySelector(".value").innerText = body.data[key];
                    }
                }else{
